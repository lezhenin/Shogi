...
namespace APP {
    ...
    private:
        ...
        std::map<std::string, int> tableOfCommands = {{"move", 2},
                                                      {"drop", 3},
                                                      {"exit", 4},
                                                      {"show", 5},
                                                      {"undo", 6}};
        std::map<std::string, PieceType> tableOfTypes = {{"pawn",           Pawn},
                                                         {"king",           King},
                                                         ...
                                                         {"knight",         Knight},
                                                         {"lance",          Lance}};
        std::map<PieceType, std::string> tableOfLabels = {{King,                  "uK"},
                                                          {GoldGeneral,           "uG"},
                                                          {Rook,                  "uR"},
                                                          {Bishop,                "uB"},
                                                          {SilverGeneral,         "uS"},
