...
namespace shogi
{
    ...
    private:
        ...
        const std::map<PieceType, std::string> tableOfTypes = {{Pawn,                  "pawn"},
                                                               {King,                  "king"},
        ...
        const std::map<Player, std::string> tableOfPlayers = {{Sente, "sente"},
                                                              {Gote,  "gote"}};

        const std::map<std::string, PieceType> reverseTableOfTypes = {{"pawn",                    Pawn},
                                                                      {"king",                    King},
        ...
        const std::map<std::string, Player> reverseTableOfPlayers = {{"sente", Sente},
                                                                     {"gote",  Gote}};
    };
}
